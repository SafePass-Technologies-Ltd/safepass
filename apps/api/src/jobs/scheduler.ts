 ...
 * process, per architecture.md's Scheduled Jobs component.
 *
 ...
 * docs/SafePass/risk_log.md and trip-archive.service.ts's retention
 * comment). This time, node-cron is genuinely load-bearing again:
 * FEAT-004 Account Deletion's 14-day cooling-off period is itself a
 * deferred/scheduled execution -- something has to
...
export function startScheduledJobs(): void {
  // FEAT-004: sweep for due account-deletion requests. Hourly matches the
  // cadence suggested in docs/SafePass/user_flow.md -- frequent enough that
  // a request rarely sits due-but-unprocessed for long,
