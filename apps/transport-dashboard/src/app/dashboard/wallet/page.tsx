  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-dark">Partner Wallet</h1>
          <p className="mt-1 text-sm text-slate-500">
            Pre-funded balance for automated trip deductions.
          </p>
        </div>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-purple-800 to-purple-950 p-8 text-white shadow-lg">
      ...
      <div>
        <h2 className="mb-4 text-lg font-semibold text-slate-dark">Transaction History</h2>
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
            {transactions.map((txn) => {
              ...
              return (
                ...
                >
                  <div className={`rounded-lg p-2 ${isCredit ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
      ...
      {showFundModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            <h2 className="text-lg font-bold text-slate-dark">Fund Partner Wallet</h2>
            <p className="mt-1 text-sm text-slate-500">
            ...
            <form onSubmit={handleFundWallet} className="mt-4 space-y-4">
              <div>
                ...
                <input
                  type="number" required min="2000" step="1000"
                  value={fundAmount}
