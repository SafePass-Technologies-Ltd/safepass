// Transport Dashboard - smoke tests
...
describe('transport dashboard app shell (login page)', () => {
  it('renders the SafePass transport login shell without crashing', () => {
    ...
    render(<LoginPage />);
    expect(screen.getByRole('heading', { level: 1, name: /safepass transport/i })).toBeTruthy();
  });
});
