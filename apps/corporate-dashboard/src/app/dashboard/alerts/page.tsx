  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-dark">Emergency Alerts</h1>
          <p className="mt-1 text-sm text-slate-500">
            Real-time safety alerts for staff on active trips. Auto-refreshes every 15 seconds.
          </p>
        </div>
        <button
          onClick={fetchAlerts}
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-1 text-sm text-slate-400">All staff on active trips are safe.</p>
        </div>
      ) : (
