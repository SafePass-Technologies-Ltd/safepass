...
| T-002 | Sync Flutter theme to spec tokens (scales; dark mode noted spec-only) | frontend | Ready | T-001 | — | — |
| T-003 | Sync dashboard Tailwind configs to spec token names | frontend | Ready | T-001 | — | — |
| T-004 | Replace stale M/A/C/T feature refs and old doc paths with FEAT-### in `apps/api/src` comments | backend | Ready | none | — | — |
| T-004f | Same stale-ref cleanup in `apps/mobile/lib` and dashboard/landing comments | frontend | Ready | none | — | — |
| T-005 | QA sweep: CONTRACTS.md matches code; spec/code parity | qa | Backlog | T-001..T-004 | all | — |
